        ...
        <div id="top">
          <div id="about-us-text">
            ...
            <div className="download">
              <button type="button" className="btn"><svg xmlns="http://www.w3.org/2000/svg"
                width="20" height="20" fill="currentColor" className="bi bi-apple mb-1" viewBox="0 0 16 16">
                <path
              ...
              <button type="button" className="btn"><svg xmlns="http://www.w3.org/2000/svg"
                width="20" height="20" fill="currentColor" className="bi bi-google-play mb-1" viewBox="0 0 16 16">
                <path
